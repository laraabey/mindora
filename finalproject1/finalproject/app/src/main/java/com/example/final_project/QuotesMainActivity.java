    ...
    private void setupClickListeners() {
        ...
        if (backArrow != null) {
            backArrow.setOnClickListener(v -> {
                // Go back to DiscoverActivity
                Intent intent = new Intent(QuotesMainActivity.this, DiscoverActivity.class);
                startActivity(intent);
                finish(); // optional, to remove QuotesMainActivity from back stack
            });
        }
    }
